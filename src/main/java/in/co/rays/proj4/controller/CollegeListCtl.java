...
public class CollegeListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setId(DataUtility.getLong(request.getParameter("city")));
		bean.setName(DataUtility.getString(request.getParameter("College")));
		System.out.println("in populate =" + request.getParameter("College"));
