...
<div class="header">
 ...
 %></td>
			<td rowspan="2"><img
				src="<%=ORSView.APP_CONTEXT%>/img/customLogo.png" width="309px"
 ...
 %> <a href="<%=ORSView.STUDENT_LIST_CTL%>">StudentList</b></a> | <a
				href="<%=ORSView.FACULTY_LIST_CTL%>">Faculty List </b></a> | <a
				href="<%=ORSView.COLLEGE_LIST_CTL%>">College List</b></a> | <a
				href="<%=ORSView.COURSE_LIST_CTL%>">Course List </b></a> | <a
				href="<%=ORSView.SUBJECT_LIST_CTL%>">Subject List</b></a> | <a
				href="<%=ORSView.TIMETABLE_LIST_CTL%>">TimeTable List</b></a> | <%-- 	 <a href="<%=ORSView.JAVA_DOC_VIEW%>" target="blank">Java Doc</b></a> --%>
