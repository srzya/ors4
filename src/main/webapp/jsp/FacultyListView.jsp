...
<body>
	...
	<div style="height: 100%; width: 100%">
 	...
 	List facultyList = (List) request.getAttribute("facultyname");
 %> <%=HTMLUtility.getList("faculty",
						String.valueOf(ServletUtility.getParameter("faculty", request)), facultyList)%>
			...
			<table id="customers">
				...
				<tr align="center">
					...
					<td align="center"><input type="checkbox" name="ids"
						class="case" value="<%=bean.getId()%>"></td>
					<%
						}
					%>
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						value="<%=FacultyListCtl.OP_PREVIOUS%>" <%if (pageNo == 1) {%>
