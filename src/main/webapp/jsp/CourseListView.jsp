		...
		<form action="<%=ORSView.COURSE_LIST_CTL%>" method="post">
			...
			<table width="100%">
				<tr>
						...
						value="<%=ServletUtility.getParameter("Descrip", request)%>">
						&nbsp;  
						 
                     
                    <% List l = (List) request.getAttribute("name"); %>
                    <label>Course Name :</label> 
                    <%=  HTMLUtility.getList("cname", String.valueOf(ServletUtility.getParameter("cname", request)), l) %>
