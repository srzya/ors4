...
<body>
	...
	<div style="height: 100%; width: 100%">
		<jsp:useBean id="bean1" class="in.co.rays.proj4.bean.SubjectBean"
			...
			<table width="100%">
				<tr>
					<td align="center"><label><b>Name</label> <input
						...
						&nbsp; <label><b>Course Name :</b></label> <%=HTMLUtility.getList("courseId",
						String.valueOf(ServletUtility.getParameter("courseId", request)), l)%>
