	...
	$(".case").click(function(){
		...
		if($(".case").length == $(".case:checked").length) {
            ...
            <table width="100%">
                <tr>
                    <td align="center">
                    <% List l = (List) request.getAttribute("rname"); %>
                    <label>Name :</label> 
                     <%=  HTMLUtility.getList("name", String.valueOf(ServletUtility.getParameter("name", request)), l) %>
                  ...
                  <%--    <% 
                    ...
                    %>
                  <%= HTMLUtility.getList("gender", rb.getName(), map)%>
                     --%>
