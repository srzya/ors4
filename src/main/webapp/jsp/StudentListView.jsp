		...
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<table width="100%">
				...
				<tr>
					...
					<%
						List l = (List) request.getAttribute("fl");
							StudentBean sbean = new StudentBean();
					%>
					<td align="center"><label> FirstName :</label> <%=HTMLUtility.getList("fname", String.valueOf(ServletUtility.getParameter("fname", request)), l)%>
			...
			<table id="customers">
				...
				<tr>
					...
					%>
					<th align="center"><input type="checkbox" id="selectall" />Select
						All</th>
					<%
						}
					%>
			...
			<table width="100%">
				<tr>
					...
					<td align="center"><input type="submit" name="operation"
						value="<%=StudentListCtl.OP_NEW%>" <%if (list.size() == 0) {%>
						disabled="disable" <%}%>></td>
